 ...
 *
 *    Коррекция *AB*:
 *    Удалено подключение файла includes.h
 *    DEF_BACKGND_COLOUR - вместо 0x00FF0 -> 0x00FFF
 *    GLCD_MANF_ID       - вместо 0x45    -> 0xFE
 *    Добавлено объявление функции void GLCD_DisplayClear(void)
 *    Добавлено объявление функции void LCD_print (const char *fmt,...)
 *    Для компилятора MDK-ARM введены имена блоков union, struct, входящих в состав таких же блоков
 *
...
#define DEF_BACKGND_COLOUR 	0x00FFF
...
#define GLCD_MANF_ID 0xFE      //For STM32-P407 - 0xFE, for IAR-STM32F407ZG-SK - 0x45
...
// Объявление для STM32-P207, для P407 дает серое изображение
...
//  GLCD_ISS_0 - Philips PCF8833,
//  GLCD_ISS_1 - Epson S1D15G00
