 ...
 *    2. Дата        : Март, 2015
 *       Автор       : МИРЭА
 *       Описание    : Использование разных таймеров для подсветки
 *    3. Дата        : Сентябрь, 2016
 *       Автор       : МИРЭА
 *       Описание    : Для подсветки по умолчанию используется TIM8
 *
 **************************************************************************/   
#ifndef __GLCD_LL_H
#define __GLCD_LL_H

// Варианты использования таймеров для подсветки
//  - по умолчанию без объявлений  : TIM3_CH3
//  - при объявлении "USE_LCD_TIM1": TIM1_CH2N 
//  - при объявлении "USE_LCD_TIM8": TIM8_CH2N
#define USE_LCD_TIM8

#ifdef USE_LCD_TIM1
  #define LCD_TIM TIM1
  #define RCC_APBPeriph_TIM RCC_APB2Periph_TIM1
  #define GPIO_AF_TIMx GPIO_AF_TIM1
#else
#ifdef USE_LCD_TIM8 
  #define LCD_TIM TIM8
  #define RCC_APBPeriph_TIM RCC_APB2Periph_TIM8
  #define GPIO_AF_TIMx GPIO_AF_TIM8
#else
  #define LCD_TIM TIM3
  #define RCC_APBPeriph_TIM RCC_APB1Periph_TIM3
  #define GPIO_AF_TIMx GPIO_AF_TIM3
#endif
#endif
...
#define LCD_BL_PIN_AF       GPIO_AF_TIMx
